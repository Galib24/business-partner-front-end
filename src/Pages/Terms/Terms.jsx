        ...
        <>
            ...
            <div className='container mx-auto px-14 py-14 my-20 rounded-3xl mt-5 w-11/12 bg-white shadow-2xl' >
                ...
                <div className=' xl:ml-16'>
                    <p className='text-base text-[#5a5a5a]'>These Terms and Conditions of Use (“Terms“) govern your use of the website located at www.businesspost.com.au  (the “SITE“) and form a binding contractual agreement between you, the user of the SITE, and Lions Group Pty Ltd trading as Business Media Group, address of Level 10 / 95 North Quay, Brisbane QLD 4000 ,  the operator of support@businesspartner.com.au  of ABN 85 088 844 204 (“BMG“)</p>
                    <h2 className='text-lg  font-semibold my-4'>1) Your acceptance of these Terms</h2>
                </div>

                <div className='xl:ml-16 my-4 text-base text-[#5a5a5a]'>
                    ...
                    <p className='my-5 text-[#5a5a5a]'>1.2. BMG reserves the right to vary the Terms and the SITE Policies at any time. Each such variation will be effective immediately upon publishing on the SITE. Your continued use of the SITE following any such variation constitutes your acceptance and agreement to be bound by the Terms and the SITE Policies, as varied. It is therefore important that you review the Terms and SITE Policies regularly.</p>
                </div>
                ...
                <div className=''>
                    ...
                    <div className='xl:ml-20 my-3 text-base text-[#5a5a5a]'>
                    ...
                    <div className='xl:ml-16 text-base text-[#5a5a5a]'>
                ...
                <div className=''>
                    ...
                    <div className='xl:ml-16 my-3 text-base text-[#5a5a5a]'>
                    ...
                    <p className='text-base my-4 xl:ml-16 text-[#5a5a5a]'> 3.2. You will be solely responsible for the use of your password and any and all activities that occur on your account, whether or not those activities are authorised by you. </p>

                    <p className='text-base my-4 xl:ml-16 text-[#5a5a5a]'> 3.3. If you become aware of any unauthorised use of your password or account, you must notify BMG immediately. </p>
                </div>
                ...
                <div>
                    ...
                    <p className='text-base my-4 xl:ml-16 text-[#5a5a5a]'> 4.1. BMG grants you a non-exclusive, worldwide, non-transferable licence to use the SITE in accordance with these Terms. </p>

                    <p className='text-base my-4 xl:ml-16'> 4.2. You may access and use the SITE (including any incidental copying that occurs as part of that use) in the normal manner, for personal non-commercial purposes. </p>
                    <p className='text-base  xl:ml-16 text-[#5a5a5a]'> 4.3. You must not add and/or remove any content to and/or from the SITE:</p>
                    <div className='xl:ml-16 text-[#5a5a5a]'>
                        <ol className='text-base mb-8'>
                            <li>
                    ...
                    <h2 className='xl:ml-16 mb-8 text-base text-[#5a5a5a]'>And you agree to indemnify BMG against any claims, actions, suits or demands made against it as a result of any content you add to or remove from the SITE in breach of this clause 4.3.</h2>


                    <p className='xl:ml-16 text-base text-[#5a5a5a]'>
                    ...
                    <p className='mt-3 text-base xl:ml-16 text-[#5a5a5a]'>
                    ...
                    <p className='my-3 text-base xl:ml-16 text-[#5a5a5a]'>
                    ...
                    <div>
                        ...
                        <h2 className='xl:ml-24 text-base text-[#5a5a5a]'>6.1. In using the SITE you agree that, unless you are specifically allowed to do so under the terms of a separate agreement with BMG, you shall not:</h2>
                    </div>

                    <div className='xl:ml-24 text-[#5a5a5a]'>
                        <ol className='text-base mb-8 text-[#5a5a5a]'>
                            <li>
                    ...
                    <div className='xl:ml-14 text-[#5a5a5a]'>
                        <ol className='text-base mb-4 text-[#5a5a5a]'>
                            <li>
                    ...
                    <h2 className='xl:ml-14 text-[#5a5a5a]'>SITE that:</h2>
                    <div className='xl:ml-14 text-[#5a5a5a]'>
                        <ol className='text-base mb-4 text-[#5a5a5a]'>
                            <li>
                    ...
                    <h2 className='xl:ml-14 mt-3 mb-9 text-[#5a5a5a]'>And you agree to indemnify BMG against any claims, actions, suits or demands made against it as a result of any Submission you provide to the SITE that breaches this clause 7.7.</h2>

                    <h2 className='xl:ml-20 font-semibold'>
                        1).Terms of Sale
                    </h2>

                    <h2 className='xl:ml-14 my-3 text-[#5a5a5a]'>
                    ...
                    <h2 className='xl:ml-14 text-[#5a5a5a]'>
                    ...
                    <h2 className='xl:ml-14 mb-3 text-[#5a5a5a]'>
                    ...
                    <h2 className='mt-3 xl:ml-14 text-[#5a5a5a]'>
                    ...
                    <p className='xl:ml-14 mt-3 text-[#5a5a5a]'>
                    ...
                    <h2 className='xl:ml-14 my-4 text-[#5a5a5a]'>
                        11.1. You will indemnify and hold BMG, its subsidiaries and their directors, officers, employees, contractors, agents and licensors harmless from any loss, damage, proceeding and cost (including all reasonable legal costs), whether in contract, tort, under statute or otherwise,
                    ...
                    <p className='xl:ml-14 my-4 text-[#5a5a5a]'>
                    ...
                    <h2 className='xl:ml-14 my-8 text-[#5a5a5a]'>
